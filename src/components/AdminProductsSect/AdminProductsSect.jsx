...
import CatalogWithFilters from "../CatalogWithFilters/CatalogWithFilters";

const AdminProductsSect = () => {
    ...
    return (
      <>
        <div className="gap-5 flex justify-around flex-col mb-5 items-center">
...
export default AdminProductsSect
